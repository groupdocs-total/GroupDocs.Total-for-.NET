...
using GroupDocs.Total.WebForms.Products.Search.Entity.Web;
using GroupDocs.Total.WebForms.Products.Search.Entity.Web.Request;
using GroupDocs.Total.WebForms.Products.Search.Service;

namespace GroupDocs.Total.WebForms.Products.Search.Controllers
{
    /// <summary>
    /// SearchApiController.
    /// </summary>
