...
namespace GroupDocs.Total.MVC.Products.Signature.Signer
{
    ...
    public class TextSigner : BaseSigner
    {
        ...
        public override SignOptions SignPdf()
        {
            ...
            GroupDocs.Signature.Options.Appearances.PdfTextAnnotationAppearance appearance = new GroupDocs.Signature.Options.Appearances.PdfTextAnnotationAppearance();
