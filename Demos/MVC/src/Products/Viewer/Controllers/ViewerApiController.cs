...
namespace GroupDocs.Total.MVC.Products.Viewer.Controllers
{
    ...
    public class ViewerApiController : ApiController
    {
        ...
        public HttpResponseMessage PrintPdf(PostedDataEntity loadDocumentRequest)
        {
            ...
            catch (Exception ex)
            {
                ...
                return this.Request.CreateResponse(
                    HttpStatusCode.InternalServerError, new Resources().GenerateException(ex, loadDocumentRequest.password));
            }
        }
        ...
        private static Stream GetPdf(PostedDataEntity postedData)
        {
            ...
            ICustomViewer viewer = globalConfiguration.GetViewerConfiguration().GetIsHtmlMode()
